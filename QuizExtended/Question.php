...
// I have added the preview functionallity
...
class Question {
	 ...
	 * @param Boolean $preview : Is the question only for preview?
	 */
	public function __construct( $beingCorrected, $caseSensitive, $questionId, $shufAns, &$parser, $preview ) {
		global $wgRequest;
